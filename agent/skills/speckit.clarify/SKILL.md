...
1. Run `.agent/skills/scripts/powershell/check-prerequisites.ps1 -Json -PathsOnly` from repo root **once** (combined `-Json -PathsOnly` mode). Parse minimal JSON payload fields:
   - `FEATURE_DIR`
   - `FEATURE_SPEC`
