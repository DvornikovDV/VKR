...
2. **Check for existing branches before creating new one**:
   ...
   d. Run the script `.agent/skills/scripts/powershell/create-new-feature.ps1 -Json "{{args}}"` with the calculated number and short-name:
      - Pass `-Number N+1` and `-ShortName "your-short-name"` along with the feature description
      - PowerShell example: `.agent/skills/scripts/powershell/create-new-feature.ps1 -Json "{{args}}" -Number 5 -ShortName "user-auth" "Add user authentication"`
