# Лист задач: Просмотр реализации сохранения/загружки + валидация
...
- [ ] Заменить одну кнопку на 2
- [ ] Обе кнопки load должны выводить file input
...
- [ ] После сохранения:
  ...
  ```
- [ ] Проверить в console: отображаются значения
...
- [ ] Обновить в ImageManager
- [ ] Тест: сохранить → загрузить → восстановилось

---

## ФАЗА 4: Обработчики (1ч)

### 4.1 Навесить обработчики кнопок
...
- [ ] Нельзя сохранить bindings без структуры
- [ ] Нельзя загрузить несовместимые bindings
- [ ] 4 кнопки работают
